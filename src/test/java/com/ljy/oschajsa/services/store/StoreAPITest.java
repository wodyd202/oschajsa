...
public class StoreAPITest extends ApiTest {
    ...
    void emptyBusinessName() throws Exception{
        OpenStore openStore = StoreFixture.aOpenStore().businessName(null).build();
    ...
    void emptyBusinessNumber() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessNumber(null).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void invalidBusinessNumber() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessNumber("invalid").build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void emptyBusinessTel() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessTel(null).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void invalidBusinessTel() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessTel("invalid").build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void nullTags() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().tags(null).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void emptyTags() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().tags(Arrays.asList()).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void emptyWeekdayStart() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessHour(StoreFixture.aChangeBusinessHour()
                        .weekdayStart(null)
                .build()).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void nullBusinessHours() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessHour(null).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void emptyLongtitude() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().coordinate(StoreFixture.aChangeCoordinate()
                        .longtitude(null)
                .build()).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void nullCoordinate() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().coordinate(null).build();
        assertBadRequestWhenOpenStore(openStore);
    }
    ...
    void open() throws Exception {
        OpenStore openStore = StoreFixture.aOpenStore().businessNumber("123-45-6789").build();
        mvc.perform(post("/api/v1/store")
